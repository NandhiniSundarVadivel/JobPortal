...
public class AdapterInboxJobSeeker extends RecyclerView.Adapter<AdapterInboxJobSeeker.MyViewHolder> {
    ...
    public AdapterInboxJobSeeker(List<InboxModel> data, Context contexts, CustomItemClickListener customItemClickListener) {
