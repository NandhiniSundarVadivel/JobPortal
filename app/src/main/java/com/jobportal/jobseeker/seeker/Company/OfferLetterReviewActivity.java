...
public class OfferLetterReviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offer_letter_review);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.linear_send:
                linearSend.setBackgroundColor(getResources().getColor(R.color.colorSignup));
                break;
        }
    }
